...
<section>
	<svg transition:fade xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103 124">
		<g opacity=0.2>
			<path
		...
		<text x=12 y=65 style="text-align: center; font-size: 6px; text-shadow: 2px 2px rgba(160, 160, 160, 0.8);">Service Worker Side Rendering</text>
	</svg>
</section>
	<style>
		section {
